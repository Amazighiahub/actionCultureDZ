...
export const NotificationBell: React.FC<NotificationBellProps> = ({
  ...
  return (
    <div className={`relative ${className}`} ref={dropdownRef}>
      ...
      {/* Dropdown */}
      {isOpen &&
      <div className={`absolute top-full mt-2 ${position === 'left' ? 'left-0' : 'right-0'} w-[calc(100vw-2rem)] sm:w-96 max-w-[400px] bg-white rounded-lg shadow-xl border border-gray-200 z-50`}>
          {/* Header */}
