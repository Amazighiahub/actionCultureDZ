/**
 * GestionArtisanatSimple - Formulaire adaptable simplifié pour artisans et admin
 * Version fonctionnelle sans erreurs TypeScript complexes
 */
...
import {
  ...
  Hammer, Tag, DollarSign, Clock, Package, CheckCircle, Shield
} from 'lucide-react';
...
const GestionArtisanatSimple: React.FC = () => {
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <Label required={mode !== 'view'}>
                      {t('gestionArtisanat.nom', 'Nom du produit')}
                    </Label>
                  ...
                  <div className="space-y-2">
                    <Label>{t('gestionArtisanat.description', 'Description')}</Label>
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                      <textarea
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label required={mode !== 'view'}>
                        {t('gestionArtisanat.materiau', 'Matériau')}
                      </Label>
                      <Select
                    ...
                    <div className="space-y-2">
                      <Label required={mode !== 'view'}>
                        {t('gestionArtisanat.technique', 'Technique')}
                      </Label>
                      <Select
...
export default GestionArtisanatSimple;
