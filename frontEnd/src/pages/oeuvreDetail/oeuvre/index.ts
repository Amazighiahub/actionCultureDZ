/**
 * Oeuvre Components - Index
 * Export centralisé des composants de la page détail œuvre
 */

// Composants pour OeuvreDetailPage
export { default as OeuvreHero } from './OeuvreHero';
export { default as OeuvreInfo } from './OeuvreInfo';
export { default as OeuvreGallery } from './OeuvreGallery';
export { default as OeuvreContributeurs } from './OeuvreContributeurs';
export { default as OeuvreComments } from './OeuvreComments';
