...
export const DashboardCharts: React.FC<DashboardChartsProps> = ({ stats, period }) => {
  ...
  const ActivityHeatmap = ({ data }: any) => {
    ...
    return (
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Activité par heure et jour</CardTitle>
        </CardHeader>
        <CardContent>
    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <DistributionChart
          ...
          title="Répartition du contenu par type"
        />
      </div>
      ...
      <Card>
        <CardHeader>
          <CardTitle className="text-lg">Comparaison avec la période précédente</CardTitle>
        </CardHeader>
        <CardContent>
          <div className="space-y-4">
            {[
              { label: 'Utilisateurs actifs', current: 1250, previous: 980, unit: '' },
              { label: 'Temps moyen de session', current: 12.5, previous: 10.2, unit: 'min' },
              { label: 'Pages vues', current: 45600, previous: 38900, unit: '' },
              { label: 'Taux de rebond', current: 32, previous: 38, unit: '%', inverse: true }
            ].map((metric, index) => {
