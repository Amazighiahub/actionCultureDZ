...
const monuments: Monument[] = [
  {
    ...
    description: "Citadelle historique inscrite au patrimoine mondial de l'UNESCO depuis 1992",
  ...
  },
  {
    ...
    region: "Illizi",
    type: "Parc national",
    description: "Plateau montagneux avec art rupestre préhistorique, patrimoine mondial UNESCO",
  ...
  },
  {
    ...
    description: "Ensemble architectural mozabite unique au monde, patrimoine UNESCO depuis 1982",
  ...
  },
  {
    ...
    description: "Ancienne cité romaine de Thamugadi, parfaitement conservée",
    image: "https://images.unsplash.com/photo-1539650116574-75c0c6d73c6e?auto=format&fit=crop&w=600&q=80",
    visiteurs: "80k/an",
    duree: "2-3h",
    heritage: "UNESCO",
  ...
  },
  {
    ...
    region: "Sétif",
    type: "Site archéologique",
    description: "Cuicul, ancienne ville romaine aux vestiges exceptionnels",
    image: "https://images.unsplash.com/photo-1539650116574-75c0c6d73c6e?auto=format&fit=crop&w=600&q=80",
    visiteurs: "60k/an",
    duree: "2h",
    heritage: "UNESCO",
  ...
  },
  {
    ...
    region: "Tipaza",
    type: "Site archéologique",
    description: "Vestiges puniques, romains et chrétiens face à la Méditerranée",
    image: "https://images.unsplash.com/photo-1539650116574-75c0c6d73c6e?auto=format&fit=crop&w=600&q=80",
    visiteurs: "120k/an",
    duree: "2-3h",
    heritage: "UNESCO",
        ...
        <CardHeader className="pb-4">
          <div className="flex items-center justify-between">
            <CardTitle className="flex items-center space-x-2 font-serif">
              ...
              <span>Carte interactive du patrimoine</span>
            </CardTitle>
            <Dialog open={carteOuverte} onOpenChange={setCarteOuverte}>
              ...
              <DialogContent className="max-w-6xl w-[95vw] h-[90vh]">
                <DialogHeader>
                  <DialogTitle className="font-serif">Exploration du patrimoine algérien</DialogTitle>
                </DialogHeader>
          ...
          <p className="text-muted-foreground">
            Explorez plus de 6 sites UNESCO et monuments historiques à travers l'Algérie
          </p>
        </CardHeader>
      ...
      <Card>
        <CardHeader>
          ...
          <p className="text-sm text-muted-foreground">
            Choisissez un itinéraire thématique pour découvrir les merveilles du patrimoine algérien
          </p>
        </CardHeader>
        <CardContent>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center justify-between text-sm text-muted-foreground">
                      <span className="flex items-center space-x-1">
                        ...
                        <span>{p.monuments.length} sites</span>
                      </span>
                      <span className="flex items-center space-x-1">
          ...
          {parcoursActif !== null && (
            <div className="mt-6 p-4 bg-muted/30 rounded-lg border-l-4 border-primary">
              <div className="flex items-center justify-between">
                <div>
                  <h4 className="font-medium">Parcours actif : {parcours[parcoursActif].nom}</h4>
                  <p className="text-sm text-muted-foreground">
                    Itinéraire tracé sur la carte avec {parcours[parcoursActif].monuments.length} monuments
                  </p>
                </div>
                <Button 
                  variant="ghost" 
                  size="sm" 
                  onClick={() => setParcoursActif(null)}
                >
                  Effacer
                </Button>
              </div>
            ...
            <div className="flex justify-between items-start">
              ...
              <div className="flex space-x-2">
                ...
                {monumentSelectionne.heritage === 'UNESCO' && (
                  <Badge className="bg-accent text-accent-foreground">UNESCO</Badge>
                )}
              </div>
            </div>
          </CardHeader>
          <CardContent className="space-y-6">
            ...
            <div className="flex space-x-3">
              ...
              <Button 
                variant="ghost" 
                size="sm"
                onClick={() => setMonumentSelectionne(null)}
              >
                Fermer
              </Button>
            </div>
