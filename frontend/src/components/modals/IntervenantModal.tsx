...
import type { NouvelIntervenant } from '@/types/api/oeuvre-creation.types';
    ...
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription>
            Créez un nouvel intervenant pour votre œuvre
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-6">
            ...
            <div className="space-y-2">
              ...
              {emailExists?.exists && (
                <p className="text-sm text-green-600">
                  Utilisateur existant : {emailExists.user?.nom} {emailExists.user?.prenom}
                </p>
              )}
            </div>
          </div>
          ...
          <div className="space-y-4 border-t pt-4">
            <h3 className="text-lg font-semibold">Rôle dans l'œuvre</h3>
            
            <div className="space-y-2">
              <Label htmlFor="id_type_user">Type de rôle *</Label>
              ...
              {relevantTypes.length > 0 && (
                <p className="text-xs text-muted-foreground">
                  {relevantTypes.length} type{relevantTypes.length > 1 ? 's' : ''} disponible{relevantTypes.length > 1 ? 's' : ''}
                </p>
              )}
            </div>
          </div>
