  ...
  const events = [
    {
      ...
      maxParticipants: 300,
      status: 'À venir',
      description: 'Célébration de l\'héritage musical andalou avec des artistes internationaux',
      price: 'Gratuit',
      image: 'https://images.unsplash.com/photo-1493225457124-a3eb161ffa5f?auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 2,
      title: 'Exposition d\'Art Contemporain Maghrébin',
      type: 'Art visuel',
      date: '5-25 Août 2024',
      location: 'Oran',
      participants: 89,
      ...
      description: 'Découverte des œuvres d\'artistes contemporains du Maghreb',
      price: '500 DA',
      image: 'https://images.unsplash.com/photo-1578662996442-48f60103fc96?auto=format&fit=crop&w=800&q=80'
    },
    {
      id: 3,
      title: 'Journées du Patrimoine Amazigh',
      type: 'Culture',
      ...
      description: 'Immersion dans la culture amazighe : langue, artisanat et traditions',
      price: '300 DA',
